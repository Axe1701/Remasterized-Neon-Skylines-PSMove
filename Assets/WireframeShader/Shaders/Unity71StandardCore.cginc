...
// Based on Unity 2017.1.0f2

#ifndef WFS_STANDARD_CORE_INCLUDED
#define WFS_STANDARD_CORE_INCLUDED
...
#define FRAGMENT_SETUP(x) FragmentCommonData x = \
    WFSFrag(i.tex, i.eyeVec, i.dist, i.tangentToWorldAndPackedData, i.posWorld);
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    WFS_OCCLUDE(occlusion, s)//WFS
    UnityGI gi = FragmentGI (s, occlusion, i.ambientOrLightmapUV, atten, mainLight);

    half4 c = UNITY_BRDF_PBS (s.diffColor, s.specColor, s.oneMinusReflectivity, s.smoothness, s.normalWorld, -s.eyeVec, gi.light, gi.indirect);
    // c.rgb += Emission(i.tex.xy); //WFS

    WFS_FINALCOLOR(c, s)//WFS
...
)
{
    ...
    WFS_FINALCOLOR(emissiveColor, s)//WFS
...
#endif // WFS_STANDARD_CORE_INCLUDED
