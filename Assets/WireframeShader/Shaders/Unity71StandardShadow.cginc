...
#ifndef WFA_STANDARD_SHADOW_INCLUDED
#define WFA_STANDARD_SHADOW_INCLUDED
...
void vertShadowCaster (VertexInput v,
    // #ifdef UNITY_STANDARD_USE_SHADOW_OUTPUT_STRUCT //WFS
...
half4 fragShadowCaster (
    VertexOutputShadowCaster i //WFS
// #ifdef UNITY_STANDARD_USE_SHADOW_OUTPUT_STRUCT
    ...
    ) : SV_Target
{
        ...
        float4 vpos = i._pos;  half alpha = WFSAlpha(i.dist, i.tex.xy, i.posWorld); //WFS
...
#endif // WFA_STANDARD_SHADOW_INCLUDED
